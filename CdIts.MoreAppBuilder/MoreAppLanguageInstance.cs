...
public class MoreAppLanguageInstance
{
    ...
    internal string GetOption(string section, string field, string option, bool allowGlobal = true, string? globalConfigSection = null, string? defaultValue = null) => File.Get(section, field, Language, $"option.{option}", allowGlobal, globalConfigSection, defaultValue);
