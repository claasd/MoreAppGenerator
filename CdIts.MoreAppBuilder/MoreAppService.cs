...
public class MoreAppService(int customerId, string secret, IMoreAppCaching? caching = null)
{
    ...
    public Task DeleteDataSource(string dataSourceId) => ActiveDataSource.DeleteAsync(_client, dataSourceId);
    public Task DeleteDataSource(IDataSource dataSource) => ActiveDataSource.DeleteAsync(_client, dataSource.Id);
